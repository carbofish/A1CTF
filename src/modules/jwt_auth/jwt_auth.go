...
var PermissionMap = map[string]PermissionSetting{
	...
	"/api/admin/user/:user_id": {RequestMethod: []string{"GET"}, Permissions: []models.UserRole{models.UserRoleAdmin}},
	...
	"/api/admin/team/hash/:team_hash": {RequestMethod: []string{"GET"}, Permissions: []models.UserRole{models.UserRoleAdmin}},
